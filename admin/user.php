                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <div class="breadcome-heading">
                                <h4 style="margin-bottom: 0px"><i class="fa fa-user"></i> Data Petugas Front Office</h4>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <ul class="breadcome-menu" style="padding-top: 0px">
                                <li><a href="#">Home</a> <span class="bread-slash">/</span></li>
                                <li><span class="bread-blod">Data Petugas FO</span></li>
                            </ul>
                        </div>
                    </div>
                </div>
...
<div class="container-fluid">
    <div class="panel panel">
        <div class="panel-heading">
            <h3 class="panel-title">Data Petugas Front Office</h3>
        </div>
        <div class="panel-body">
            <div class="pull-right">
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalTambah_<?php echo $p['user_id']; ?>"><i class="fa fa-plus"></i> Tambah Data Petugas</button>
				<!-- Kode Modal Cetak-->
				<div class="modal fade" id="modalTambah_<?php echo $p['user_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <tbody>
                    ...
                    while($p = mysqli_fetch_array($user)){
                        ...
                        <tr>
							...
							<td><?php echo $p['user_notelp'] ?></td>
							<td><?php echo $p['user_alamat'] ?></td>
                            <td class="text-center">
                                <div class="btn-group">
									<button type="button" class="btn btn-warning" data-toggle="modal" data-target="#modalAkun_<?php echo $p['user_id']; ?>"><i class="fa fa-user"></i></button>
									...
									<button type="button" class="btn btn-danger" data-toggle="modal" data-target="#modalDelete_<?php echo $p['user_id']; ?>"><i class="fa fa-trash"></i></button>
                                </div>
								<!-- Kode Modal Delete-->
								<div class="modal fade" id="modalDelete_<?php echo $p['user_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
									<div class="modal-dialog modal-dialog-centered" role="document">
										<div class="modal-content">
											<div class="modal-header text-center">
							...
							<!-- Kode Modal Cetak-->
							<div class="modal fade" id="modalAkun_<?php echo $p['user_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
								<div class="modal-dialog modal-dialog-centered" role="document">
									<div class="modal-content">
										<div class="modal-header text-center">
											...
											<div class="panel-body">
												<form action="user_akun.php" method="POST" enctype="multipart/form-data">
													<div class="form-group">
														...
														<input type="number" class="form-control" name="nip" required="required" value="<?php echo $p['user_nip'] ?>">
													</div>
													<div class="form-group">
										...
										<div class="modal-body" id="modalBody_<?php echo $p['user_id']; ?>">
											...
											<div class="panel-body">
												<form method="post" action="user_update.php" enctype="multipart/form-data">
													...
													<div class="form-group">
														<label>Email</label>
														<input type="text" class="form-control" name="email" required="required" value="<?php echo $p['user_email']; ?>">
													</div>
													<div class="form-group">
														<label>No, Telp</label>
